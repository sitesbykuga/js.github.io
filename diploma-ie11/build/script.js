      ...
      function feedback() {
        ...
        function showSlide(n, direction) {
          ...
          for (var _i5 = 0; _i5 < sliderItems.length; _i5++) {
            sliderItems[_i5].classList.remove(classAnimate[0]);
            sliderItems[_i5].classList.remove(classAnimate[1]);
            sliderItems[_i5].style.display = 'none';
          }
    ...
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      ...
      function popup(element, btnClassName) {
        ...
        function closePopup() {
          ...
          for (var _i6 = 0; _i6 < textarea.length; _i6++) {
            textarea[_i6].value = '';
          };
          openModal--;
        };
    ...
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      function sendForm(formElement) {
        ...
        setTimeout(function () {
          ...
          for (var _i7 = 0; _i7 < textarea.length; _i7++) {
            textarea[_i7].value = '';
          }
        }, 3000);
      };
    ...
    (function (process, global, Buffer, __argument0, __argument1, __argument2, __argument3, __filename, __dirname) {
      function slider() {
        ...
        function showSlide() {
          ...
          for (var _i8 = 0; _i8 < mainSliderItem.length; _i8++) {
            mainSliderItem[_i8].classList.remove('fadeInDown');
            mainSliderItem[_i8].classList.remove('fadeOutDown');
            mainSliderItem[_i8].style.display = 'none';
          }
